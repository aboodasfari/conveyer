...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::tasks::task_local_set_done,
            ...
            commands::comments::comments_for_phase,
            commands::comments::comment_create,
            commands::comments::comment_accept,
            commands::comments::comment_reopen,
            commands::comments::comment_delete,
